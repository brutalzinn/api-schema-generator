...
console.log(
  `<<< ${name} v${version} BOOTCAMP-NIGHT-API. Uma api para simular conexão com banco de dados e facilitar o desenvolvimento da camada de interface. Rodando na porta ${process.env.PORT} >>>`
);
